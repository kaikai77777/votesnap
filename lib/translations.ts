export const zh = {
  ...
  // Onboarding
  'ob.steps': '稱呼,年齡,性別,興趣',
  'ob.nameTitle': '怎麼稱呼你？', 'ob.nameSub': '你的暱稱，會出現在分享結果上', 'ob.namePlaceholder': '例如：小明、阿凱',
...
export const en = {
  ...
  'ob.steps': 'Name,Age,Gender,Interests',
  'ob.nameTitle': "What should we call you?", 'ob.nameSub': 'Your nickname will appear on shared results', 'ob.namePlaceholder': 'e.g. Alex, KK',
