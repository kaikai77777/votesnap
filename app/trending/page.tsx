      ...
      <main className="pt-20 pb-20 px-4 max-w-lg mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center mt-20 text-gray-600">
            ...
            <p className="text-sm">{isEn ? 'No questions yet for this period' : '這段期間還沒有問題'}</p>
            <Link href="/ask" className="btn-gradient px-6 py-3 rounded-2xl text-sm mt-4 inline-block">
              {isEn ? 'Ask Something →' : '發第一題 →'}
            </Link>
          </div>
        ) : (
