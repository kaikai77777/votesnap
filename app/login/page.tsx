...
function LoginContent() {
  ...
  useEffect(() => {
    if (searchParams.get('error')) setError(t('login.error'))
  ...
  return (
    <div className="relative w-full max-w-sm">
      ...
      <div className="card p-8">
        ...
        <div className="mt-4 text-center text-gray-600 text-xs">{t('login.apple')}</div>
        <p className="text-gray-600 text-xs text-center mt-6 leading-relaxed">{t('login.terms')}</p>
      </div>
    </div>
  )
}
